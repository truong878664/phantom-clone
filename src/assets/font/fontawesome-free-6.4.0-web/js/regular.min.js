...
!(function () {
  ...
  var o = i(
      (M((L = {}), h, { solid: 'fas', regular: 'far', light: 'fal', thin: 'fat', duotone: 'fad', brands: 'fab', kit: 'fak' }),
      M(L, t, { solid: 'fass', regular: 'fasr', light: 'fasl' }),
      L),
    ),
    H =
      (i(
        (M((l = {}), h, { fab: 'fa-brands', fad: 'fa-duotone', fak: 'fa-kit', fal: 'fa-light', far: 'fa-regular', fas: 'fa-solid', fat: 'fa-thin' }),
